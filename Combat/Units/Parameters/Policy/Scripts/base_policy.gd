...
## Returns the maximum possible damage output of the given [param attack].
## By default, this is computed as the attack's damage multiplied by the maximum
## number of targets it can affect (assuming equal damage to each).
## Policies with more complex damage distribution should override this method
## to provide more accurate results.
## Does account for accuracy.
## Does not account for random deviations.
