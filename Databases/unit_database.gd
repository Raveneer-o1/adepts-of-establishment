...
, &"base_damage": 90, &"max_hp": 600, &"armor": 20, &"evasion": 0.005, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u26_vision_of_darkness.tscn", &"level": 4, &"large_unit": null, &"immunities": [3]
, &"description": "The Vision of Darkness is an eldritch apparition that embodies the deepest fears of the living. It projects illusions to disorient and terrify enemies, making them vulnerable to other undead forces. With its commanding aura and mind-twisting abilities, the Vision of Darkness is both a psychological and magical powerhouse on the battlefield.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 25, &"max_hp": 150, &"armor": 0, &"evasion": 0.2, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u32_undying_nighthunter.tscn", &"level": 4, &"large_unit": true, &"immunities": null, &"description": "The Undying Nighthunter is a dragon that defies the limitations of mortality. Rising from death, it becomes a relentless predator of the night, hunting down its prey with precision and terror. Its ability to vanish into darkness make it a nightmare of living, and no enemy escapes its wrath.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 150, &"armor": 10, &"evasion": 0.05, &"shielding_chance": 0.75 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u27_wyvern.tscn", &"level": null, &"large_unit": true, &"immunities": null, &"description": "Wyverns are the earthbound cousins of dragons, stripped of the freedom of flight. Their bitterness over this difference drives them to seek power, often turning to the God of Death for strength and vengeance. While physically imposing, wyverns lack the majesty of true dragons, channeling their rage into ferocious attacks.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 50, &"max_hp": 300, &"armor": 0, &"evasion": 0.005, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u18_herald_of_death.tscn", &"level": 4, &"large_unit": null, &"immunities": [3]
...
, &"base_damage": 60, &"max_hp": 180, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u21_ghost.tscn", &"level": null, &"large_unit": null, &"immunities": [3]
, &"description": "Ghosts are the lingering spirits of the dead, cursed to wander the mortal realm. Though their spectral forms are fragile, they are immune to physical attacks, making them tricky opponents. Their chilling presence weakens the resolve of their enemies, while their attacks drain the vitality of the living leaving them paralyzed.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 0, &"max_hp": 70, &"armor": 0, &"evasion": 0.07, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u31_the_devourer.tscn", &"level": 4, &"large_unit": true, &"immunities": null, &"description": "The Devourer is a monstrous snake-like creature, bloated with the power of countless consumed souls. Its sheer size and overwhelming strength make it an unstoppable force, crushing enemies under its bulk. Its feeding frenzy is unending, spreading despair and destruction across the battlefield.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 30, &"max_hp": 75, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u07_skeleton_warrior.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Elite undead warriors, crafted from the bones of legendary fighters. Their bodies are reinforced with necromantic magic, granting them unparalleled strength and durability. Clad in ancient, rune-inscribed armor, they lead lesser undead into battle with an imposing presence that inspires dread in their enemies.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 80, &"max_hp": 275, &"armor": 35, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u01_destined.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "The Destined are individuals who pledge their lives to the King of Necropolis even before death claims them. This devotion grants them a fragile connection to the forces of death, allowing them to manipulate minor necromantic powers. However, their frail, living bodies struggle to withstand the rigors of combat", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 35, &"max_hp": 90, &"armor": 0, &"evasion": 0.04, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u02_Zombie.tscn", &"level": 2, &"large_unit": null, &"immunities": [3]
, &"description": "Zombies are the reanimated corpses of the recently deceased, brought back to life through dark magic. Slow and uncoordinated, they rely on their overwhelming resilience to survive attacks that would fell most living warriors. Though lacking in intelligence, their sheer persistence makes them a constant threat on the battlefield.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 10, &"max_hp": 100, &"armor": 0, &"evasion": 0.1, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u06_fallen_inquisitor.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Once holy warriors, Fallen Inquisitors were corrupted by the Necropolis\'s dark power. Now they wield their former knowledge of divine magic against the living, combining brutal melee combat with devastating unholy spells. Their tragic fall from grace is reflected in their fierce hatred for their former brethren, making them relentless in battle.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
 "silence": 0 
}, &"alternative_actions": []
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 20, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u16_elder_vampire.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Elder Vampires are ancient beings whose bloodlust excel limits of a mortal mind. They possess extraordinary strength and command blood magic with terrifying precision. Their mere presence inspires awe and dread, as they dominate the battlefield with their unmatched prowess and cunning.", &"faction": 2, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 3, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
...
, &"base_damage": 60, &"max_hp": 220, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u29_gluttonous_serpent.tscn", &"level": 3, &"large_unit": true, &"immunities": null, &"description": "The Gluttonous Serpent is a grotesque creature that has abandoned all thought for insatiable hunger. With an elongated, serpentine body and jaws capable of consuming multiple foes, it leaves destruction in its wake. Though mindless, its appetite makes it an overwhelming force that overwhelms through sheer persistence.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 120, &"max_hp": 600, &"armor": 20, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u17_archlich.tscn", &"level": 4, &"large_unit": null, &"immunities": [3]
...
, &"description": "The pinnacle of undead draconic evolution. The Dracolich is an intelligent lich-dragon whose very presence decays the living. It commands legions of the dead and wields a breath of pure entropy, making it the ultimate instrument of oblivion.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 200, &"max_hp": 1000, &"armor": 50, &"evasion": 0.01, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u19_blood_spawn.tscn", &"level": 5, &"large_unit": null, &"immunities": null, &"description": "Blood Spawn are the monstrous remnants of vampires who succumbed to their insatiable bloodlust. Mutated beyond recognition, they embody pure rage and hunger, striking terror into the hearts of all who face them. Their brutal attacks and unrelenting ferocity make them devastating forces of destruction, but their mindless nature renders them dangerous to friend and foe alike.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 100, &"max_hp": 350, &"armor": 50, &"evasion": 0.1, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u15_wraith.tscn", &"level": 3, &"large_unit": null, &"immunities": [3]
...
, &"base_damage": 40, &"max_hp": 100, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u14_lich.tscn", &"level": 3, &"large_unit": null, &"immunities": [3]
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 20, &"evasion": 0.05, &"shielding_chance": 0.0 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u24_shadow.tscn", &"level": 3, &"large_unit": null, &"immunities": [3]
, &"description": "Shadow\'s very essence a manifestation of fear and despair. They attack by engulfing their targets in a cold, suffocating void, sapping their strength and will. Difficult to detect and harder to fight, Shadows excel at ambushing their prey and disrupting enemy formations.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 75, &"max_hp": 285, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u04_phantom_warrior.tscn", &"level": 3, &"large_unit": null, &"immunities": [3]
, &"description": "Phantom Warriors are spectral remnants of fallen soldiers, bound to the will of the Necropolis. They drift across the battlefield, their incorporeal forms allowing them to evade physical attacks. Armed with ghostly weapons, they deliver chilling strikes that sap the vitality of their foes, leaving them weakened and vulnerable.", &"faction": 2, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 180, &"armor": 10, &"evasion": 0.1, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Undead/u28_doomdrake.tscn", &"level": 2, &"large_unit": true, &"immunities": null, &"description": "A wyvern that succumbs to the influence of the Necropolis transforms into a Doomdrake. These beasts consume the fallen on the battlefield, growing stronger and more twisted with each kill. They are brutal shock troops, relentless in their charge and devastating in their bite, embodying the death they now serve.", &"faction": 2, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 35, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_archer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
 "Poison": [20, 2]
...
, &"base_damage": 15, &"max_hp": 50, &"armor": 0, &"evasion": 0.045, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/grave_whisperer.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 150, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/dame_seraphine.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 70, &"max_hp": 200, &"armor": 20, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/virion_the_bonebinder.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 50, &"max_hp": 170, &"armor": 15, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/knight_champion.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 70, &"max_hp": 200, &"armor": 65, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/h02 thymaël_doux.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 200, &"armor": 40, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/cartographer.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 30, &"max_hp": 160, &"armor": 10, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/bone_collector.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 40, &"max_hp": 110, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/margrave_solreth.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 40, &"max_hp": 180, &"armor": 10, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/h01 High mage.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 30, &"max_hp": 150, &"armor": 30, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Heroes/sir_roland.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.8, &"targets_needed": 1, &"initiative": 0, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 40, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e23 Marksman.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Marksmen are archers who have honed their craft, wielding longbows for greater range and accuracy. Their arrows strike with precision, making them ideal for targeting critical threats or weakening heavily armored foes.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 75, &"armor": 0, &"evasion": 0.136, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e02 Witch hunter.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Witch Hunters are zealous warriors trained to purge dark magic and heresy wherever it festers. Armed with specialized tools and unwavering faith, they excel at confronting spellcasters and disrupting their powers. Their knowledge of arcane threats makes them formidable foes against the unnatural.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 100, &"max_hp": 350, &"armor": 50, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e08 Blade Saint.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Blade Saints are legendary swordsmen whose mastery of the blade borders on the supernatural. Their movements are fluid and precise, cutting through enemies with unmatched grace and speed. Years of discipline and devotion to their craft have made them nearly invincible.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 275, &"armor": 35, &"evasion": 0.2, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e29 Priest.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Priests are experienced healers, capable of invoking potent divine blessings to restore a significant amount of health to a single ally. Their focused prayers can turn the tide of a skirmish by ensuring critical combatants remain in the fight.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 40, &"max_hp": 110, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e19 White Mage.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "The most powerful wizards are granted the title of White Mages. The storms they can summon on the battlefield can wipe out entire armies.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 55, &"max_hp": 180, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e31 Imperial priest.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Clergymen are stalwart defenders of faith and life, wielding potent healing magic to sustain their allies. Their unwavering devotion allows them to keep even gravely wounded warriors in the fray. They are a cornerstone of any formation, ensuring the survival of their party\'s strongest fighters.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": true, &"type": 3, &"accuracy": 1.0, &"targets_needed": 1, &"initiative": 10, &"evadable": false, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_healer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
 "cure": null 
}, &"alternative_actions": []
...
, &"base_damage": 20, &"max_hp": 50, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e25 Assassin.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Masters of shdows, assassins prefer poison over the raw strength.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 100, &"max_hp": 350, &"armor": 70, &"evasion": 0.05, &"shielding_chance": 0.8 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e28 Cleric.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Clerics provide balanced healing to the entire party, spreading divine energy to mend multiple allies at once. Though their magic isn’t as potent as focused healers, their ability to stabilize the group makes them indispensable in prolonged battles.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 25, &"max_hp": 100, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e11 Royal Cavalier.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Royal Cavaliers are the backbone of the kingdom\'s mounted forces, blending power and precision. Equipped with finely crafted lances and sturdy armor, they excel at breaking enemy formations with calculated charges. Their training and discipline ensure they remain steadfast under pressure, offering reliable strength on the battlefield", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 275, &"armor": 50, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e01 Squire.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "The squire is an eager trainee, taking their first steps toward knighthood. Though their armor is light and their skills unpolished, they stand bravely on the front lines. Often serving as assistants to knights, squires are willing to risk much to prove their worth.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 30, &"max_hp": 100, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e22 Archer.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "Archers are the backbone of any ranged offense, skilled in the art of precision and timing. Armed with simple bows, they provide consistent support from the backlines, picking off weaker targets or softening up foes before the main assault.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 30, &"max_hp": 50, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e26 Imperial Ranger.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "The elite among archers, Imperial Rangers are masters of the bow and forest warfare. With unparalleled accuracy and exceptional survival skills, they can track and eliminate enemies from the shadows. Their arrows are often enhanced with specialized tips, capable of piercing even the strongest defenses.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 140, &"armor": 0, &"evasion": 0.296, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e09 Grand Inquisitor.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Grand Inquisitors channel divine energy to manifest enormous spectral warhammers, delivering crushing blows that bypass magical defenses. Their presence on the battlefield bolsters the vitality of nearby allies, increasing their resilience against even the fiercest assaults. With unwavering conviction, they serve as both protectors and avengers, ensuring the light triumphs over darkness.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 275, &"armor": 35, &"evasion": 0.15, &"shielding_chance": 0.6 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e33 Hierophant.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Hierophants are revered figures, blessed with the power to channel miracles. In addition to healing grievous injuries, they can resurrect fallen allies, bringing hope to even the bleakest battlefields. Their presence inspires courage, as their divine powers can restore both body and spirit.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 180, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e17 Ritualist.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Ritualists delve into ancient and forbidden rites, channeling their energy to summon otherworldly beings or cast powerful curses. Their unique strength lies in their ability to turn the tide of battle by conjuring allies from empty spaces on the battlefield.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 120, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e05 Inquisitor.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Inquisitors are relentless hunters of heresy, wielding heavy maces to deliver unyielding punishment. Their attacks pierce through magical defenses, making them especially deadly against spellcasters and enchanted foes. Unshakable in their faith, they inspire their allies and bring fear to the corrupted. On the battlefield, an Inquisitor is a resolute force of righteousness, relentless in their pursuit of heretics and the unholy.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 20, &"evasion": 0.1, &"shielding_chance": 0.6 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e03 Knight.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Knights are the backbone of any noble army, embodying valor and discipline on the battlefield. Clad in sturdy armor and wielding weapons with practiced skill, they excel at defending their allies and striking down foes. Trained in the art of mounted and foot combat, they are versatile warriors capable of holding the line or leading a charge. Their unwavering resolve inspires those who fight beside them.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 45, &"max_hp": 150, &"armor": 20, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e04 Samurai.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Samurai are elite warriors who combine unmatched discipline with masterful swordsmanship. Adhering to a strict code of honor, they are steadfast defenders of their allies, standing unyielding in the face of overwhelming odds. With swift, precise strikes and the ability to anticipate their foes\' moves, samurai can atack twice.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 80, &"max_hp": 200, &"armor": 15, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e10 Angel Knight.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Angel Knights are celestial warriors clad in radiant armor, wielding swords blessed with divine power. Their strikes are swift and unerring, cutting through darkness and doubt with righteous precision. With their holy aura, they inspire nearby allies, enhancing their offensive capabilities.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 100, &"max_hp": 200, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e18 Wizard.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Wizards are masters of advanced arcane arts, capable of reshaping the battlefield with devastating spells and area control. Their ability to manipulate energy allows them to strike multiple enemies or weaken their defenses with precision.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 110, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e16 Mage.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Mages are practitioners of refined arcane knowledge, capable of channeling powerful spells to damage foes. However, their focus on spellcasting leaves them physically vulnerable, relying on careful positioning and team support to maximize their potential.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 30, &"evadable": true, &"tags": []
...
, &"base_damage": 30, &"max_hp": 75, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e24 Scout.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Scouts are nimble and resourceful, blending speed with precision. They excel at quick strikes and harassing enemy formations. Their agility allows them to avoid direct confrontation, making them invaluable for reconnaissance and flanking maneuvers in tactical skirmishes.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 60, &"max_hp": 100, &"armor": 0, &"evasion": 0.208, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e06 Knight Master.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Knight Masters are paragons of martial skill, commanding respect on the battlefield with their imposing presence and unwavering discipline. Equipped with masterfully crafted armor and weapons, they excel in both offense and defense, standing as stalwart protectors of their allies. A Knight Master is a symbol of honor and strength, embodying the virtues of their order.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 50, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e07 Horseman.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Horsemen are swift and adaptable warriors who rely on speed and maneuverability to outflank enemies and strike with precision. Their mobility makes them invaluable for rapid assaults or defensive countermeasures. A Horseman’s strength lies not only in their combat prowess but in their ability to turn the tide of battle with quick and decisive actions.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 0.4, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 70, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/melee_with_move.tres", &"additional_targets": "", &"damage_policy": "res://Combat/Units/Parameters/Policy/melee_with_move_policy.tres", &"applying_effects": {
...
, &"base_damage": 60, &"max_hp": 200, &"armor": 35, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e15 Elementalist.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Elementalists are specialists who wield the raw forces of nature, calling upon the elements to devastate their enemies. Their mastery of summoning allows them to conjure elemental creatures to fight alongside them, disrupting enemy formations.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 30, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/elementalist_validity.tres", &"additional_targets": "", &"damage_policy": "res://Combat/Units/Parameters/Policy/elementalist_policy.tres", &"applying_effects": {
...
, &"base_damage": 30, &"max_hp": 75, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e30 Matriarch.tscn", &"level": 3, &"large_unit": null, &"immunities": null, &"description": "Matriarchs are pillars of divine strength, safeguarding the vitality of their entire party. Their healing magic envelops all allies, keeping them resilient against the relentless tides of war. Their presence fosters unity and endurance among their comrades.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": true, &"type": 3, &"accuracy": 1.0, &"targets_needed": 1, &"initiative": 10, &"evadable": false, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_healer_validity.tres", &"additional_targets": "res://Combat/Units/Parameters/Additional targets/mass_heal_targets.tres", &"damage_policy": "", &"applying_effects": {
 "random_buff": [1, 5, 1.1]
...
, &"base_damage": 45, &"max_hp": 150, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Empire/e27 Acolyte.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "Acolytes are the fledgling healers of the faith, channeling divine energy to mend the wounds of their allies. While their healing power is limited, their dedication to protecting their comrades is unwavering.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": true, &"type": 3, &"accuracy": 1.0, &"targets_needed": 1, &"initiative": 10, &"evadable": false, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_healer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 45, &"max_hp": 150, &"armor": 10, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/pirate_captain.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Pirate Captains are charismatic and ruthless leaders, commanding their crews with a mix of fear and admiration. Their combat skills are matched by their ability to inspire their followers, turning a ragtag crew into a formidable fighting force.", &"faction": 6, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 90, &"max_hp": 275, &"armor": 20, &"evasion": 0.1, &"shielding_chance": 0.3 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/rogue.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Rogues are seasoned fighters who blend agility and combat prowess, striking quickly and decisively. They are masters of deception, often using dirty tricks to gain the upper hand. Though they prefer to avoid direct confrontation, their versatility makes them a dangerous adversary.", &"faction": 7, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 30, &"max_hp": 150, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/ogre.tscn", &"level": 2, &"large_unit": true, &"immunities": null, &"description": "Ogres are hulking brutes with unparalleled physical power, smashing through enemies and obstacles alike. Though not known for their intelligence, their immense strength and resilience make them formidable foes. These behemoths are often used as shock troops, devastating enemy ranks with crushing blows.", &"faction": 8, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 30, &"max_hp": 100, &"armor": 0, &"evasion": 0.1, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/robber.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 7, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 0, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 75, &"max_hp": 180, &"armor": 10, &"evasion": 0.08, &"shielding_chance": 0.0 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/goblin_shaman.tscn", &"level": 2, &"large_unit": null, &"immunities": null, &"description": "Goblin Shamans wield primitive but potent magic, channeling the chaotic energy of their tribe’s spirit rituals. They serve as both support and disruptors, casting spells that weaken enemies or bolster their allies.", &"faction": 8, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 45, &"max_hp": 75, &"armor": 10, &"evasion": 0.1, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/orc_chieftain.tscn", &"level": 4, &"large_unit": null, &"immunities": null, &"description": "Orc Chieftains are the leaders of their clans, commanding respect through strength and cunning. They inspire their kin with battle cries and powerful strikes, rallying their forces to victory.", &"faction": 8, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"base_damage": 80, &"max_hp": 275, &"armor": 35, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Neutral/thief.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "Thieves are nimble and cunning, excelling in stealth and precision strikes. They specialize in exploiting enemy weaknesses, targeting vulnerabilities for devastating effect.", &"faction": 1, &"unit_type": 0, &"needed_xp": 0, &"attacks": [{
...
, &"base_damage": 25, &"max_hp": 100, &"armor": 0, &"evasion": 0.05, &"shielding_chance": 0.7 
 ...
 &"scene_path": "res://Combat/Units/Derived units//Elemental.tscn", &"level": null, &"large_unit": null, &"immunities": null, &"description": "", &"faction": 6, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_archer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
