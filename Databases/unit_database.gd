...
, &"description": "Zombies are the reanimated corpses of the recently deceased, brought back to life through dark magic. Slow and uncoordinated, they rely on their overwhelming resilience to survive attacks that would fell most living warriors. Though lacking in intelligence, their sheer persistence makes them a constant threat on the battlefield.", &"faction": 2, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Once holy warriors, Fallen Inquisitors were corrupted by the Necropolis\'s dark power. Now they wield their former knowledge of divine magic against the living, combining brutal melee combat with devastating unholy spells. Their tragic fall from grace is reflected in their fierce hatred for their former brethren, making them relentless in battle.", &"faction": 2, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
 "silence": 0 
}, &"alternative_actions": []
...
, &"description": "The Gluttonous Serpent is a grotesque creature that has abandoned all thought for insatiable hunger. With an elongated, serpentine body and jaws capable of consuming multiple foes, it leaves destruction in its wake. Though mindless, its appetite makes it an overwhelming force that overwhelms through sheer persistence.", &"faction": 2, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Blood Spawn are the monstrous remnants of vampires who succumbed to their insatiable bloodlust. Mutated beyond recognition, they embody pure rage and hunger, striking terror into the hearts of all who face them. Their brutal attacks and unrelenting ferocity make them devastating forces of destruction, but their mindless nature renders them dangerous to friend and foe alike.", &"faction": 2, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Phantom Warriors are spectral remnants of fallen soldiers, bound to the will of the Necropolis. They drift across the battlefield, their incorporeal forms allowing them to evade physical attacks. Armed with ghostly weapons, they deliver chilling strikes that sap the vitality of their foes, leaving them weakened and vulnerable.", &"faction": 2, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Marksmen are archers who have honed their craft, wielding longbows for greater range and accuracy. Their arrows strike with precision, making them ideal for targeting critical threats or weakening heavily armored foes.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Blade Saints are legendary swordsmen whose mastery of the blade borders on the supernatural. Their movements are fluid and precise, cutting through enemies with unmatched grace and speed. Years of discipline and devotion to their craft have made them nearly invincible.", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Priests are experienced healers, capable of invoking potent divine blessings to restore a significant amount of health to a single ally. Their focused prayers can turn the tide of a skirmish by ensuring critical combatants remain in the fight.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
...
, &"description": "The most powerful wizards are granted the title of White Mages. The storms they can summon on the battlefield can wipe out entire armies.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Masters of shdows, assassins prefer poison over the raw strength.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Clerics provide balanced healing to the entire party, spreading divine energy to mend multiple allies at once. Though their magic isn’t as potent as focused healers, their ability to stabilize the group makes them indispensable in prolonged battles.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Royal Cavaliers are the backbone of the kingdom\'s mounted forces, blending power and precision. Equipped with finely crafted lances and sturdy armor, they excel at breaking enemy formations with calculated charges. Their training and discipline ensure they remain steadfast under pressure, offering reliable strength on the battlefield", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Samurai are elite warriors who combine unmatched discipline with masterful swordsmanship. Adhering to a strict code of honor, they are steadfast defenders of their allies, standing unyielding in the face of overwhelming odds. With swift, precise strikes and the ability to anticipate their foes\' moves, samurai can atack twice.", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Wizards are masters of advanced arcane arts, capable of reshaping the battlefield with devastating spells and area control. Their ability to manipulate energy allows them to strike multiple enemies or weaken their defenses with precision.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Scouts are nimble and resourceful, blending speed with precision. They excel at quick strikes and harassing enemy formations. Their agility allows them to avoid direct confrontation, making them invaluable for reconnaissance and flanking maneuvers in tactical skirmishes.", &"faction": 1, &"unit_type": 1, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Knight Masters are paragons of martial skill, commanding respect on the battlefield with their imposing presence and unwavering discipline. Equipped with masterfully crafted armor and weapons, they excel in both offense and defense, standing as stalwart protectors of their allies. A Knight Master is a symbol of honor and strength, embodying the virtues of their order.", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
...
, &"description": "Elementalists are specialists who wield the raw forces of nature, calling upon the elements to devastate their enemies. Their mastery of summoning allows them to conjure elemental creatures to fight alongside them, disrupting enemy formations.", &"faction": 1, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 30, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/elementalist_validity.tres", &"additional_targets": "", &"damage_policy": "res://Combat/Units/Parameters/Policy/elementalist_policy.tres", &"applying_effects": {
...
, &"description": "Matriarchs are pillars of divine strength, safeguarding the vitality of their entire party. Their healing magic envelops all allies, keeping them resilient against the relentless tides of war. Their presence fosters unity and endurance among their comrades.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": true, &"type": 3, &"accuracy": 1.0, &"targets_needed": 1, &"initiative": 10, &"evadable": false, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_healer_validity.tres", &"additional_targets": "res://Combat/Units/Parameters/Additional targets/mass_heal_targets.tres", &"damage_policy": "", &"applying_effects": {
 "random_buff": [1, 5, 1.1]
...
, &"description": "Acolytes are the fledgling healers of the faith, channeling divine energy to mend the wounds of their allies. While their healing power is limited, their dedication to protecting their comrades is unwavering.", &"faction": 1, &"unit_type": 3, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": true, &"type": 3, &"accuracy": 1.0, &"targets_needed": 1, &"initiative": 10, &"evadable": false, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_healer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"description": "Pirate Captains are charismatic and ruthless leaders, commanding their crews with a mix of fear and admiration. Their combat skills are matched by their ability to inspire their followers, turning a ragtag crew into a formidable fighting force.", &"faction": 6, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"description": "Rogues are seasoned fighters who blend agility and combat prowess, striking quickly and decisively. They are masters of deception, often using dirty tricks to gain the upper hand. Though they prefer to avoid direct confrontation, their versatility makes them a dangerous adversary.", &"faction": 7, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "", &"faction": 7, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 0, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"description": "Goblin Shamans wield primitive but potent magic, channeling the chaotic energy of their tribe’s spirit rituals. They serve as both support and disruptors, casting spells that weaken enemies or bolster their allies.", &"faction": 8, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
...
, &"description": "Orc Chieftains are the leaders of their clans, commanding respect through strength and cunning. They inspire their kin with battle cries and powerful strikes, rallying their forces to victory.", &"faction": 8, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 0, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_melee_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
...
, &"description": "Thieves are nimble and cunning, excelling in stealth and precision strikes. They specialize in exploiting enemy weaknesses, targeting vulnerabilities for devastating effect.", &"faction": 1, &"unit_type": 4, &"needed_xp": 0, &"attacks": [{
...
, &"description": "", &"faction": 6, &"unit_type": 2, &"needed_xp": 0, &"attacks": [{
 &"damage_multiplier": 1.0, &"damage_override": false, &"is_heal": false, &"type": 1, &"accuracy": 0.95, &"targets_needed": 1, &"initiative": 40, &"evadable": true, &"tags": []
, &"target_validation": "res://Combat/Units/Parameters/Validation/standard_archer_validity.tres", &"additional_targets": "", &"damage_policy": "", &"applying_effects": {
