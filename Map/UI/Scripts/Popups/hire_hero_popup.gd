class_name HireHeroPopup
extends PopupBase

var current_source: MapInteractableObject
@onready var ui_layers: MapUI = $"../.."

@onready var units_item_list: ItemList = %HireHeroesItemList
@onready var portrait_texture: TextureRect = %HireHero_UnitPanel/VBoxContainer/TextureRect
@onready var description: RichTextLabel = %HireHero_UnitPanel/VBoxContainer/RichTextLabel
@onready var info: RichTextLabel = %HireHero_UnitPanel/MarginContainer/RichTextLabel
@onready var hire_unit_unit_panel: HBoxContainer = %HireHero_UnitPanel
@onready var resource_panel_gold: MarginContainer = %HireHero_ResourcePanel_Gold
@onready var resource_panel_stone: MarginContainer = %HireHero_ResourcePanel_Stone
@onready var resource_panel_crystals: MarginContainer = %HireHero_ResourcePanel_Crystals
...
func display_for_object(node: MapInteractableObject, list: Array[StringName]) -> void:
